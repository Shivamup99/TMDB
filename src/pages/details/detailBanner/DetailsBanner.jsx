            ...
            {!loading ? (
               <>
                <div className="backdrop-img">
                    <Img src={ url.backdrop + data?.backdrop_path} alt='kksk' />
                </div>
                ...
                <ContentWrapper>
                    <div className="content">
                        <div className="left">
                            {data?.poster_path ?(
                                <Img className='posterImg' src={url.backdrop + data?.poster_path} alt='namw' />
                            )
                            :( <Img className='posterImg' src={PosterFallback} alt='makka' />)}
                        </div>
                        <div className="right">
                            <div className="title">
                                {`${data?.title || data?.original_name} (${dayjs(data?.release_date).format('YYYY')})`}
                            </div>
